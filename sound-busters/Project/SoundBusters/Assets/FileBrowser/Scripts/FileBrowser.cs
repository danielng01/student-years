...
//public 
	...
	public Color selectedColor = new Color(0.6f,0.6f,0.9f); //the color of the selected file
...
//Protected	
	...
	//public FileBrowser(string directory,int layoutStyle):this(directory,layoutStyle,new Rect(Screen.height*0.05f,Screen.height*0.05f,Screen.width-Screen.height*0.1f,Screen.height*0.9f)){}
	...
	public bool draw(){
		...
		switch(layout){
			...
			default:
				...
				fileScroll = GUILayout.BeginScrollView(fileScroll, GUIStyle.none, GUIStyle.none);
				...
				//if((selectStyle == null)?GUILayout.Button("Select"):GUILayout.Button("Select",selectStyle)){	return true;	}
				//if((cancelStyle == null)?GUILayout.Button("Cancel"):GUILayout.Button("Cancel",cancelStyle))
				if(GUILayout.Button("Select")){	return true;}
